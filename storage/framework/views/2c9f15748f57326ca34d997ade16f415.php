...
<div class="create-bug-wrapper d-flex justify-content-center align-items-center px-3">
    <div class="bug-create-panel">
        ...
        <?php endif; ?>
        <form method="POST" action="<?php echo e(route('bugs.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
            ...
            <div class="mb-4">
                ...
                <select class="form-control" id="assigned_to" name="assigned_to">
                    ...
                    <option value="<?php echo e($dev->id); ?>"><?php echo e($dev->name); ?> (<?php echo e($dev->email); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="d-flex justify-content-end gap-2">
                <a href="<?php echo e(url()->previous()); ?>" class="btn btn-outline-light" style="--bs-btn-color:#fff; --bs-btn-border-color:#ffffff55; --bs-btn-hover-bg:#ffffff22;">Cancel</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\nirma\Documents\New folder\resources\views/bugs/create.blade.php ENDPATH**/ ?>